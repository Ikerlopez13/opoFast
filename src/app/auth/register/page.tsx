              ...
              <div className="flex items-start space-x-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-blue-700 mb-3">
                    T'hem enviat un correu de confirmació a <strong>{email}</strong>
                  </p>
                  <div className="text-xs text-blue-600 space-y-1">
                    <p>• Revisa la teva safata d'entrada</p>
                    <p>• Si no el veus, comprova la carpeta de spam</p>
                    <p>• Fes clic a l'enllaç per activar el teu compte</p>
                    <p>• Després podràs iniciar sessió normalment</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
              <div className="flex items-start space-x-2">
                ...
                <div className="text-sm text-blue-700">
                  <p className="font-medium mb-1">📧 Verificació de correu electrònic</p>
                  <p>Després de crear el compte, t'enviarem un correu de confirmació. Hauràs de verificar la teva adreça de correu abans de poder iniciar sessió.</p>
                </div>
              </div>
            </div>
