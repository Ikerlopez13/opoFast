...
export default function BombersPage() {
  ...
  const handlePremiumClick = () => {
    ...
    } else if (isPremium('bombers')) {
      router.push('/dashboard');
    } else {
      // TODO: Redirect to payment/checkout
      console.log('Redirect to payment for Bombers subscription');
    }
  };
        ...
        <div className="container mx-auto px-6 md:px-12 py-12 md:py-16">
          <div className="max-w-5xl mx-auto text-center">
            ...
            <p className="text-2xl md:text-3xl text-gray-700 mb-12 max-w-4xl mx-auto font-medium">
              Desbloqueja tot el potencial dels tests de Bombers
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-8 md:gap-12 max-w-5xl mx-auto">
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-300">
              ...
              <button 
                ...
                className="w-full text-white py-4 px-6 rounded-xl text-lg font-semibold hover:opacity-90 transition-colors duration-200" 
            ...
            <div className="bg-white rounded-3xl p-8 md:p-10 shadow-2xl border-2 relative overflow-visible" style={{ borderColor: '#5FBFF9' }}>
              ...
              <button 
                onClick={handlePremiumClick}
                className="w-full text-white py-5 px-6 rounded-xl text-lg font-bold hover:opacity-90 transition-all duration-200 shadow-lg flex items-center justify-center" 
                style={{ backgroundColor: '#5FBFF9' }}
              >
          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Tests Actualitzats</h3>
                <p className="text-gray-600">Accés a més de 2.500 preguntes actualitzades segons l'últim temari oficial</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Simulacres Reals</h3>
                <p className="text-gray-600">Practica amb simulacres que repliquen exactament les condicions de l'examen oficial</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2">Seguiment Detallat</h3>
                <p className="text-gray-600">Analitza el teu progrés amb estadístiques detallades i identifica les àrees a millorar</p>
              </div>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-6">
              ...
              <div className="bg-white rounded-2xl p-6 md:p-8 shadow-sm">
                <h3 className="text-xl font-semibold text-gray-900 mb-3">
                  Què inclou el pla Premium per a Bombers?
                </h3>
                <p className="text-gray-600 leading-relaxed">
                  El pla Premium per a Bombers de Catalunya inclou accés il·limitat a totes les preguntes específiques 
              ...
              <div className="bg-white rounded-2xl p-6 md:p-8 shadow-sm">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Sí, tots els tests de Bombers de Catalunya s'actualitzen constantment amb la normativa vigent, 
                  incloent-hi legislació catalana, protocols d'emergència i temari específic de l'oposició.
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-6 md:px-12 pb-16 md:pb-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-white rounded-3xl p-8 md:p-12 shadow-xl max-w-2xl mx-auto">
              ...
              <button 
                onClick={handlePremiumClick}
                className="w-full text-white py-5 px-8 rounded-xl text-xl font-bold hover:opacity-90 transition-all duration-200 shadow-lg" 
                style={{ backgroundColor: '#5FBFF9' }}
              >
                Fes-te Premium ara 29,99€ →
              </button>
